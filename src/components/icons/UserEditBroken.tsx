...
const SvgUserEditbroken = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M15.02 3.01A4.94 4.94 0 0 0 12 2C9.24 2 7 4.24 7 7s2.24 5 5 5 5-2.24 5-5"
    />
    <path
      stroke="#171717"
      strokeLinecap="round"
...
export default SvgUserEditbroken;
