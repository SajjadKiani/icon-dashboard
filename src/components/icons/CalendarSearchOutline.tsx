...
const SvgCalendarSearchoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M22 22.75c-.19 0-.38-.07-.53-.22l-1-1a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l1 1c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22M8.5 14.5c-.13 0-.26-.03-.38-.08a.9.9 0 0 1-.33-.21c-.04-.05-.09-.1-.12-.15a.8.8 0 0 1-.09-.18.6.6 0 0 1-.06-.18c-.01-.07-.02-.14-.02-.2 0-.26.11-.52.29-.71q.135-.135.33-.21c.36-.16.81-.07 1.09.21.18.19.29.45.29.71 0 .06-.01.13-.02.2q-.015.09-.06.18-.03.09-.09.18l-.12.15c-.19.18-.45.29-.71.29M12 14.5c-.26 0-.52-.11-.71-.29-.18-.19-.29-.44-.29-.71 0-.13.03-.26.08-.38q.075-.18.21-.33c.37-.37 1.04-.37 1.42 0 .18.19.29.45.29.71 0 .06-.01.13-.02.2q-.015.09-.06.18-.03.09-.09.18l-.12.15c-.19.18-.45.29-.71.29M8.5 18c-.26 0-.52-.11-.71-.29-.18-.19-.29-.45-.29-.71 0-.13.03-.26.08-.38q.075-.195.21-.33c.37-.37 1.05-.37 1.42 0 .18.19.29.45.29.71s-.11.52-.29.71c-.19.18-.45.29-.71.29M20.5 9.84h-17c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h17c.41 0 .75.34.75.75s-.34.75-.75.75"
    />
    <path
      fill="#171717"
      d="M13.37 22.75H8c-3.65 0-5.75-2.1-5.75-5.75V8.5c0-3.65 2.1-5.75 5.75-5.75h8c3.65 0 5.75 2.1 5.75 5.75V13c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8.5c0-2.86-1.39-4.25-4.25-4.25H8c-2.86 0-4.25 1.39-4.25 4.25V17c0 2.86 1.39 4.25 4.25 4.25h5.37c.41 0 .75.34.75.75s-.34.75-.75.75"
    />
  </svg>
);
export default SvgCalendarSearchoutline;
