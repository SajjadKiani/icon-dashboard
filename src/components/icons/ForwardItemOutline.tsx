...
const SvgForwardItemoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#171717"
      d="M13.62 18.13h-3.23c-3.13 0-4.52-1.39-4.52-4.52v-3.23c0-3.13 1.39-4.52 4.52-4.52h3.23c3.13 0 4.52 1.39 4.52 4.52v3.23c-.01 3.13-1.4 4.52-4.52 4.52M10.38 7.37c-2.29 0-3.02.73-3.02 3.02v3.23c0 2.29.73 3.02 3.02 3.02h3.23c2.29 0 3.02-.73 3.02-3.02v-3.23c0-2.29-.73-3.02-3.02-3.02z"
    />
    <path
      fill="#171717"
...
export default SvgForwardItemoutline;
