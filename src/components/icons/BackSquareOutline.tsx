...
const SvgBackSquareoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M8.57 11.52c-.19 0-.38-.07-.53-.22L6.47 9.73a.754.754 0 0 1 0-1.06L8.04 7.1c.29-.29.77-.29 1.06 0s.29.77 0 1.06L8.06 9.2l1.04 1.04a.75.75 0 0 1-.53 1.28"
    />
  </svg>
);
export default SvgBackSquareoutline;
