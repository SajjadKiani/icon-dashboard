...
const SvgWalletChecktwotone = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M17.75 7.05C17.51 7.01 17.26 7 17 7H7q-.42 0-.81.06c.14-.28.34-.54.58-.78l3.25-3.26a3.525 3.525 0 0 1 4.96 0l1.75 1.77c.64.63.98 1.43 1.02 2.26"
      opacity={0.4}
    />
    <path
      stroke="#171717"
...
export default SvgWalletChecktwotone;
