...
const SvgLocationoutline = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#171717"
      d="M12 14.17c-2.13 0-3.87-1.73-3.87-3.87S9.87 6.44 12 6.44s3.87 1.73 3.87 3.87-1.74 3.86-3.87 3.86m0-6.23c-1.3 0-2.37 1.06-2.37 2.37s1.06 2.37 2.37 2.37 2.37-1.06 2.37-2.37S13.3 7.94 12 7.94"
    />
    <path
      fill="#171717"
