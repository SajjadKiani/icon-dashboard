...
const SvgBitcoinBtcOutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M12.57 19.25c-.41 0-.75-.34-.75-.75v-2.17c0-.41.34-.75.75-.75s.75.34.75.75v2.17c0 .41-.33.75-.75.75M9.87 19.25c-.41 0-.75-.34-.75-.75v-2.17c0-.41.34-.75.75-.75s.75.34.75.75v2.17c0 .41-.34.75-.75.75M12.57 8.42c-.41 0-.75-.34-.75-.75V5.5c0-.41.34-.75.75-.75s.75.34.75.75v2.17c0 .41-.33.75-.75.75M9.87 8.42c-.41 0-.75-.34-.75-.75V5.5c0-.41.34-.75.75-.75s.75.34.75.75v2.17c0 .41-.34.75-.75.75"
    />
    <path
      fill="#171717"
      d="M10.84 8.42H7.05c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h3.79a.749.749 0 1 1 0 1.5M10.84 17.08H7.05c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h3.79a.749.749 0 1 1 0 1.5"
    />
  </svg>
);
export default SvgBitcoinBtcOutline;
