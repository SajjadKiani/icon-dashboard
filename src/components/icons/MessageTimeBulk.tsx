...
const SvgMessageTimebulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M15.5 11.25h-7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h7c.41 0 .75.34.75.75s-.34.75-.75.75M5 13.5c-.94 0-1.81.33-2.5.88A3.97 3.97 0 0 0 1 17.5c0 2.21 1.79 4 4 4a4 4 0 0 0 2.64-1c.83-.73 1.36-1.8 1.36-3 0-2.21-1.79-4-4-4m1 4.25c0 .26-.14.51-.36.64l-1.25.75c-.12.07-.25.11-.39.11-.25 0-.5-.13-.64-.36-.21-.36-.1-.82.26-1.03l.89-.53v-1.08c0-.41.34-.75.75-.75s.75.34.75.75v1.5z"
    />
  </svg>
);
export default SvgMessageTimebulk;
