...
const SvgLocationSlashoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M5.99 18.56c-.23 0-.46-.11-.61-.31-2.4-3.29-3.24-6.63-2.49-9.93.78-3.43 3.3-5.97 6.74-6.8 3.6-.87 7.38.3 9.61 2.97.27.32.22.79-.09 1.06a.75.75 0 0 1-1.06-.1c-1.87-2.24-5.05-3.21-8.11-2.48-2.92.7-4.97 2.77-5.63 5.67-.65 2.86.1 5.79 2.24 8.71.24.33.17.8-.16 1.05-.13.11-.29.16-.44.16M12 22.76a5.97 5.97 0 0 1-4.13-1.67.746.746 0 0 1-.02-1.06c.29-.3.76-.31 1.06-.02a4.425 4.425 0 0 0 6.17 0c2.67-2.57 5.63-6.63 4.57-11.34a.753.753 0 0 1 1.47-.33c1.22 5.39-2.04 9.91-4.99 12.75A5.97 5.97 0 0 1 12 22.76"
    />
    <path
      fill="#171717"
...
export default SvgLocationSlashoutline;
