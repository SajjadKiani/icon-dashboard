...
const SvgPenTool2Bulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#171717"
      d="M12.52 1.5h-1c-.83 0-1.5.67-1.5 1.5v1c0 .83.67 1.5 1.5 1.5h1c.83 0 1.5-.67 1.5-1.5V3c0-.83-.67-1.5-1.5-1.5M4.27 10.67h-1c-.83 0-1.5.67-1.5 1.5v1c0 .83.67 1.5 1.5 1.5h1c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.68-1.5-1.5-1.5M20.73 10.67h-1c-.83 0-1.5.67-1.5 1.5v1c0 .83.67 1.5 1.5 1.5h1c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.67-1.5-1.5-1.5"
    />
    <path
      fill="#171717"
      d="M3.75 11.92c-.41 0-.75-.34-.75-.75 0-4.27 3.2-7.86 7.44-8.36.4-.04.78.25.83.66s-.25.78-.66.83a6.92 6.92 0 0 0-6.11 6.87c0 .41-.34.75-.75.75M20.25 11.92c-.41 0-.75-.34-.75-.75 0-3.49-2.61-6.44-6.07-6.86a.744.744 0 0 1-.65-.83c.05-.41.43-.7.84-.65 4.21.51 7.39 4.1 7.39 8.35-.01.4-.34.74-.76.74M13.29 22.01h-2.57c-.92 0-1.6-.74-1.43-1.54l.42-1.85h4.59l.42 1.85c.19.85-.45 1.54-1.43 1.54"
    />
    <path
      fill="#171717"
...
export default SvgPenTool2Bulk;
