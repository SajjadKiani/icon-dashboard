...
const SvgHashtagbulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M18.82 10.58c.4 0 .73-.33.73-.73s-.33-.73-.73-.73h-3.61l.39-3.5c.04-.4-.24-.76-.65-.81-.4-.04-.76.24-.81.65l-.41 3.66H10.9l.39-3.5c.04-.4-.24-.76-.65-.81-.4-.04-.76.24-.81.65l-.4 3.66H5.9c-.4 0-.73.33-.73.73s.33.73.73.73h3.37l-.32 2.85H5.18c-.4 0-.73.33-.73.73s.33.73.73.73h3.61l-.39 3.5c-.04.4.24.76.65.81h.08c.37 0 .68-.28.73-.65l.41-3.66h2.84l-.39 3.5c-.04.4.24.76.65.81h.08c.37 0 .68-.28.73-.65l.41-3.66h3.53c.4 0 .73-.33.73-.73s-.33-.73-.73-.73h-3.37l.32-2.85zm-5.56 2.84h-2.84l.32-2.85h2.84z"
    />
  </svg>
);
export default SvgHashtagbulk;
