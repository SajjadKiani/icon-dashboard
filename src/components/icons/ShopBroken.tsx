...
const SvgShopbroken = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M3.01 15.71C3.01 20.2 4.81 22 9.3 22h5.39c4.49 0 6.29-1.8 6.29-6.29v-4.49M12 12c1.83 0 3.18-1.49 3-3.32L14.34 2H9.67L9 8.68C8.82 10.51 10.17 12 12 12"
    />
    <path
      stroke="#171717"
      strokeLinecap="round"
