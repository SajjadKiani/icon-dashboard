...
const SvgAirdropoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#171717"
      d="M12 13.74c-.78 0-1.52-.3-2.09-.86-.73-.73-1.02-1.78-.78-2.81a2.91 2.91 0 0 1 2.14-2.14c1.02-.25 2.07.04 2.81.78s1.02 1.78.78 2.81a2.91 2.91 0 0 1-2.14 2.14c-.24.05-.48.08-.72.08m0-4.4c-.12 0-.25.02-.37.05-.5.12-.91.53-1.03 1.03-.13.52.01 1.03.38 1.39.37.37.87.5 1.4.38.5-.12.91-.53 1.03-1.03.13-.52-.01-1.03-.38-1.39-.28-.28-.64-.43-1.03-.43"
    />
    <path
      fill="#171717"
    ...
    <path
      fill="#171717"
      d="M16 15.3a.746.746 0 0 1-.54-1.26c.83-.88 1.29-2.04 1.29-3.24 0-2.62-2.13-4.74-4.74-4.74a4.75 4.75 0 0 0-4.74 4.74c0 1.21.46 2.36 1.29 3.24.28.3.27.78-.03 1.06s-.78.27-1.06-.03a6.23 6.23 0 0 1-1.7-4.27c0-3.44 2.8-6.24 6.24-6.24s6.24 2.8 6.24 6.24c0 1.59-.6 3.11-1.7 4.27a.78.78 0 0 1-.55.23"
    />
    <path
      fill="#171717"
...
export default SvgAirdropoutline;
