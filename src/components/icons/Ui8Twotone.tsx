...
const SvgUi8Twotone = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={1.5}
      d="M19 9.87v6.86c0 .78-.45 1.48-1.15 1.81l-6.5 3.06c-.54.25-1.16.25-1.7 0l-6.5-3.06C2.45 18.21 2 17.51 2 16.73V9.27c0-.78.45-1.48 1.15-1.81l6.5-3.06a2.02 2.02 0 0 1 1.7 0l2.67 1.26C14 5.77 14 5.89 14 6c0 2.21 1.79 4 4 4 .35 0 .68-.04 1-.13Z"
    />
    <path
      stroke="#171717"
      strokeLinecap="round"
