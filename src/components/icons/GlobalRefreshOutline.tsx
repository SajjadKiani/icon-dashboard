...
const SvgGlobalRefreshoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M20.04 15.55c-.21 0-.42-.09-.57-.26l-1.25-1.43a.756.756 0 0 1 .07-1.06c.31-.27.78-.24 1.06.07l1.25 1.43c.27.31.24.79-.07 1.06-.14.13-.31.19-.49.19"
    />
    <path
      fill="#171717"
      d="M18.58 16.61c-.23 0-.46-.11-.61-.31-.24-.33-.17-.8.16-1.05l1.46-1.06c.33-.25.8-.17 1.05.16.24.33.17.8-.16 1.05l-1.46 1.06a.7.7 0 0 1-.44.15"
    />
  </svg>
);
export default SvgGlobalRefreshoutline;
