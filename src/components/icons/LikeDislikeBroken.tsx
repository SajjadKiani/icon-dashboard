...
const SvgLikeDislikebroken = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeWidth={1.5}
      d="M2.016 20.28c0 .8.34 1.09 1.14 1.09h.57c.8 0 1.14-.29 1.14-1.09v-5.6c0-.8-.34-1.09-1.14-1.09h-.57c-.8 0-1.14.29-1.14 1.09v1.5"
    />
    <path
      stroke="#171717"
      strokeMiterlimit={10}
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M22.016 3.72c0-.8-.34-1.09-1.14-1.09h-.57c-.8 0-1.14.29-1.14 1.09v5.6c0 .8.34 1.09 1.14 1.09h.57c.8 0 1.14-.29 1.14-1.09V8"
    />
  </svg>
);
export default SvgLikeDislikebroken;
