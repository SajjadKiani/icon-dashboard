...
const SvgBackwardItembroken = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.96 6.75c.41-.09.89-.13 1.42-.13H13v1.23c0 2.25.9 3.15 3.15 3.15h1.23v2.62c0 2.69-1.07 3.76-3.76 3.76H11v-1.23C11 13.9 10.1 13 7.85 13H6.62v-2.62"
    />
  </svg>
);
export default SvgBackwardItembroken;
