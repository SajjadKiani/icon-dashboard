...
const SvgCalendarAddoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#171717"
      d="M8 5.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75M16 5.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75M8.5 14.5c-.13 0-.26-.02-.38-.08q-.18-.075-.33-.21c-.18-.19-.29-.45-.29-.71 0-.13.03-.26.08-.38q.075-.18.21-.33.15-.135.33-.21c.36-.15.81-.07 1.09.21q.135.15.21.33c.05.12.08.25.08.38 0 .26-.11.52-.29.71-.19.18-.45.29-.71.29M12 14.5c-.26 0-.52-.11-.71-.29q-.135-.15-.21-.33a1 1 0 0 1-.08-.38c0-.26.11-.52.29-.71.28-.28.72-.37 1.09-.21q.18.075.33.21c.18.19.29.45.29.71 0 .13-.02.26-.08.38q-.075.18-.21.33-.15.135-.33.21c-.12.06-.25.08-.38.08M8.5 18c-.13 0-.26-.03-.38-.08q-.18-.075-.33-.21c-.18-.19-.29-.44-.29-.71 0-.13.03-.26.08-.38.05-.13.12-.23.21-.33q.15-.135.33-.21c.36-.16.81-.07 1.09.21.09.1.16.2.21.33.05.12.08.25.08.38 0 .27-.11.52-.29.71-.19.18-.45.29-.71.29M20.5 9.84h-17c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h17c.41 0 .75.34.75.75s-.34.75-.75.75M18 23.75c-2.62 0-4.75-2.13-4.75-4.75s2.13-4.75 4.75-4.75 4.75 2.13 4.75 4.75-2.13 4.75-4.75 4.75m0-8c-1.79 0-3.25 1.46-3.25 3.25s1.46 3.25 3.25 3.25 3.25-1.46 3.25-3.25-1.46-3.25-3.25-3.25"
    />
    <path
      fill="#171717"
      d="M19.49 19.8H16.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2.99a.749.749 0 1 1 0 1.5"
    />
    <path
      fill="#171717"
      d="M18 21.33c-.41 0-.75-.34-.75-.75v-2.99c0-.41.34-.75.75-.75s.75.34.75.75v2.99c0 .41-.34.75-.75.75"
    />
    <path
      fill="#171717"
...
export default SvgCalendarAddoutline;
