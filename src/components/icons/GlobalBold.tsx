...
const SvgGlobalbold = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="#171717" clipPath="url(#global_bold_svg__a)">
    ...
    <defs>
      <clipPath id="global_bold_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgGlobalbold;
