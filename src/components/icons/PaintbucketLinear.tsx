...
const SvgPaintbucketlinear = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={1.5}
      clipPath="url(#paintbucket_linear_svg__a)"
    >
    ...
    <defs>
      <clipPath id="paintbucket_linear_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgPaintbucketlinear;
