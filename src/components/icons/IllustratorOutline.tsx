...
const SvgIllustratoroutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M11.94 12.57H7.53v1.5h4.41zM16.35 16.72c-.41 0-.75-.34-.75-.75v-5.29c0-.41.34-.75.75-.75s.75.34.75.75v5.29c0 .41-.34.75-.75.75M16.35 9.03a1.015 1.015 0 0 1-.93-.61c-.05-.13-.07-.25-.07-.39 0-.13.02-.26.07-.38.06-.12.13-.23.22-.32.09-.1.2-.17.32-.22.37-.15.82-.06 1.09.22a.995.995 0 0 1 .3.7c0 .14-.03.27-.08.39s-.12.23-.22.32c-.09.09-.2.17-.32.22s-.25.07-.38.07"
    />
    <path
      fill="#171717"
...
export default SvgIllustratoroutline;
