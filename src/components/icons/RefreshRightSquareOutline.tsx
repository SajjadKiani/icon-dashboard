...
const SvgRefreshRightSquareoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M14.38 8.4c-.21 0-.42-.09-.57-.26l-1.67-1.91a.756.756 0 0 1 .07-1.06c.31-.27.79-.24 1.06.07l1.67 1.91c.27.31.24.79-.07 1.06-.14.13-.31.19-.49.19"
    />
    <path
      fill="#171717"
      d="M12.44 9.82c-.23 0-.46-.11-.61-.31-.24-.33-.17-.8.16-1.05l1.94-1.42c.33-.24.8-.17 1.05.16.24.33.17.8-.16 1.05l-1.94 1.42c-.13.1-.29.15-.44.15"
    />
  </svg>
);
export default SvgRefreshRightSquareoutline;
