...
const SvgReceiptDiscounttwotone = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m6.27 13.73 5.46-5.46M11.925 13.5h.009M6.195 8.5h.009"
      opacity={0.4}
    />
  </svg>
);
export default SvgReceiptDiscounttwotone;
