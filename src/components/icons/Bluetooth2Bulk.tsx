...
const SvgBluetooth2Bulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M6.62 13.38c-.76 0-1.38-.62-1.38-1.38s.62-1.38 1.38-1.38S8 11.24 8 12s-.62 1.38-1.38 1.38m0-1.5c-.07 0-.12.06-.12.12 0 .14.25.14.25 0 0-.07-.06-.12-.13-.12M17.38 13.38c-.76 0-1.38-.62-1.38-1.38s.62-1.38 1.38-1.38 1.38.62 1.38 1.38-.63 1.38-1.38 1.38m0-1.5c-.07 0-.12.06-.12.12 0 .14.25.14.25 0a.14.14 0 0 0-.13-.12"
    />
  </svg>
);
export default SvgBluetooth2Bulk;
