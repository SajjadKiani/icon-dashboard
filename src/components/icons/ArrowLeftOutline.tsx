...
const SvgArrowLeftoutline = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#171717"
      d="M15.5 12.75h-6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75"
    />
    <path
      fill="#171717"
      d="M11.5 15.75c-.19 0-.38-.07-.53-.22l-3-3a.754.754 0 0 1 0-1.06l3-3c.29-.29.77-.29 1.06 0s.29.77 0 1.06L9.56 12l2.47 2.47c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22"
    />
  </svg>
);
