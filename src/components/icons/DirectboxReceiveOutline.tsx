...
const SvgDirectboxReceiveoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#171717"
      d="M12 8.75c-.1 0-.19-.02-.29-.06a.74.74 0 0 1-.46-.69V2c0-.41.34-.75.75-.75s.75.34.75.75v4.19l.72-.72c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-2 2c-.14.14-.34.22-.53.22"
    />
    <path
      fill="#171717"
    ...
    <path
      fill="#171717"
      d="M5 12.75c-.41 0-.75-.34-.75-.75V8c0-1.94 0-4.35 3.68-4.7.41-.04.78.26.82.68.04.41-.26.78-.68.82-2.32.21-2.32 1.15-2.32 3.2v4c0 .41-.34.75-.75.75M19 12.75c-.41 0-.75-.34-.75-.75V8c0-2.05 0-2.99-2.32-3.21a.75.75 0 0 1-.67-.82c.04-.41.4-.72.82-.67 3.68.35 3.68 2.76 3.68 4.7v4a.77.77 0 0 1-.76.75"
    />
  </svg>
);
export default SvgDirectboxReceiveoutline;
