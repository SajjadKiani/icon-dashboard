...
const SvgSmsStarbulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M12 12.87c-.84 0-1.69-.26-2.34-.79l-3.13-2.5a.748.748 0 0 1 .93-1.17l3.13 2.5c.76.61 2.05.61 2.81 0 .32-.26.79-.21 1.05.12.26.32.21.8-.12 1.05-.64.53-1.49.79-2.33.79"
    />
  </svg>
);
export default SvgSmsStarbulk;
