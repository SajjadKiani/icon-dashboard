...
const SvgShieldCrossoutline = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M14.15 14.19c-.19 0-.38-.07-.53-.22L9.37 9.72a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l4.25 4.25c.29.29.29.77 0 1.06-.15.14-.34.22-.53.22"
    />
    <path
      fill="#171717"
      d="M9.85 14.23c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l4.25-4.25c.29-.29.77-.29 1.06 0s.29.77 0 1.06l-4.25 4.25c-.14.15-.34.22-.53.22"
    />
  </svg>
);
export default SvgShieldCrossoutline;
