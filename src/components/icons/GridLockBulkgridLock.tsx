...
const SvgGridLockbulkgridLock = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path fill="#171717" d="M8.4 8.61H1.94v6.94H8.4z" opacity={0.4} />
    <path fill="#171717" d="M15.33 8.61v5.94c0 .55-.45 1-1 1H8.39V8.61z" />
    <path fill="#171717" d="M15.33 2.17H8.39v6.45h6.94z" opacity={0.4} />
  </svg>
);
export default SvgGridLockbulkgridLock;
