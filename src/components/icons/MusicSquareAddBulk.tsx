...
const SvgMusicSquareAddbulk = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#171717"
      d="M16.84 21.97c-.3-.26-.56-.57-.76-.91A3.9 3.9 0 0 1 15.5 19c0-2.21 1.79-4 4-4 1.18 0 2.25.51 2.97 1.33.01.01.01.02.02.02 0-.06.01-.11.01-.16V7.81C22.5 4.17 20.33 2 16.69 2H8.31c-.28 0-.55.01-.81.05-3.15.29-5 2.4-5 5.76v8.38c0 3.36 1.85 5.47 5 5.76.26.04.53.05.81.05h8.38c.06 0 .11-.01.17-.01 0-.01-.01-.01-.02-.02"
      opacity={0.4}
    />
    <path
      fill="#171717"
...
export default SvgMusicSquareAddbulk;
